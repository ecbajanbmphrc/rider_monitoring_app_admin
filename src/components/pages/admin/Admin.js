...
export default function Admin(){
    ...
    async function getUser(){
      await  axios
        .post('http://54.255.154.99:8082/get-admin-user', requestBody)
        .then(async response=> {
    ...
    async function sendOtp(){
      await axios
        .post('http://54.255.154.99:8082/send-otp-register', {email : adminEmail})
        .then(async response=> {
    ...
    async function confirmOtp(){
      ...
      if(otpCode === inputOtpCode) {
        ...
        axios
        .post('http://54.255.154.99:8082/register-user-admin', userDetails)
        .then(async response=> {
