...
export default function Hub(){    
      ...
      },
      {
       ...
       <>
          <Stack direction="row" spacing={2}>
              ...
              <Button color="info" variant="contained" size="small" style={{width: "100%" ,marginTop: "13px"}} onClick={onClickView} >View</Button>
              <Button color="info" variant="contained" size="small" style={{width: "100%", marginTop: "13px" }} onClick={onClickEdit}>Edit</Button>
    ...
    return(
        ...
        <div style={{margin: 10}}>
            <Button onClick={handleOpen} variant="contained" endIcon={<AddBox/>}>Add Hub</Button>
        </div>
          ...
          >
            <Box sx={style}>
              ...
              <FormControl fullWidth sx={{ m: 1 }}>
                  ...
                  label="Amount"
                  onChange={(evt) => { setHubName(evt.target.value); }}
                  />
            </FormControl>
            <FormControl fullWidth sx={{ m: 1 }}>
                  <TextField
        ...
        <div style={{height: '50%', width: '100%', margin: 9}}> 
          <div className="leaflet-container">
            <MapContainer center={[14.6091, 121.0223]} zoom={11} scrollWheelZoom={false}  style={{ height: "100%", minHeight: '100%', width: '100%' }}>
            <TileLayer
        ...
        <div style={{height: '90%', width: '100%', margin: 9}}> 
          <div className="leaflet-container">
            <MapContainer center={[viewLatitude, viewLongitude]} zoom={11} scrollWheelZoom={false}  style={{ height: "100%", minHeight: '100%', width: '100%' }}>
            <TileLayer
             attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
             url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
            />
            <Marker position={[viewLatitude, viewLongitude]} icon={new Icon({iconUrl: markerIconPng, iconSize: [25, 41], iconAnchor: [12, 41]})}>
            {/* <Popup>
            {city}, <br /> {street}
            </Popup> */}
            <LocationFinderDummy/>
          ...
          >
            <Box sx={style}>
              ...
              <FormControl fullWidth sx={{ m: 1 }}>
                  ...
                  label="Amount"
                  value={editHubName}
                  onChange={(evt) => { setEditHubName(evt.target.value); }}
                  />
            </FormControl>
            <FormControl fullWidth sx={{ m: 1 }}>
                  <TextField
                    ...
                    rows={3}
                    value={editAddress}
                    onChange={(evt) => { setEditAddress(evt.target.value); }}
                  />
            </FormControl>
            <FormControl fullWidth sx={{ m: 1, minWidth: 120 }}>
                  <InputLabel id="demo-simple-select-helper-label">Region</InputLabel>
        ...
        <div style={{height: '50%', width: '100%', margin: 9}}> 
          <div className="leaflet-container">
            <MapContainer center={[editLatitude, editLongitude]} zoom={11} scrollWheelZoom={false}  style={{ height: "100%", minHeight: '100%', width: '100%' }}>
            <TileLayer
             attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
             url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
            />
            <Marker position={[editLatitude, editLongitude]} icon={new Icon({iconUrl: markerIconPng, iconSize: [25, 41], iconAnchor: [12, 41]})}>
            {/* <Popup>
            {city}, <br /> {street}
            </Popup> */}
            <LocationFinderEdit/>
