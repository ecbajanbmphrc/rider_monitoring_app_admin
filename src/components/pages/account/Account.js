...
export default function Account() {
  ...
  async function getUser() {
    await axios
      .post("http://192.168.50.139:8082/get-rider-user", requestBody)
      .then(async (response) => {
  ...
  async function getHubList() {
    await axios
      .post("http://192.168.50.139:8082/fetch-hub", requestBody)
      .then(async (response) => {
        const data = await response.data.data;
  ...
  async function updateUserHub() {
    await axios
      .put("http://192.168.50.139:8082/update-user-hub", {
        hub_id: updateHub,
        email: modalEmail,
      })
      .then(async (response) => {
  ...
  async function updateUserDetails() {
    await axios
      .put("http://192.168.50.139:8082/update-user-detail-admin", {
